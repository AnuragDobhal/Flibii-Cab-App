        ...
        com.google.android.gms.location.LocationListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mapFragment.getMapAsync(DriversMapsActivity.this);
        ...
        AssignedCustomerPickUpRefListner = AssignedCustomerPickUpRef.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    PickUpMarker = mMap.addMarker(new MarkerOptions().position(DriverLatLng).title("Customer PickUp Location").icon(BitmapDescriptorFactory.fromResource(R.drawable.users)));
                }
            }
