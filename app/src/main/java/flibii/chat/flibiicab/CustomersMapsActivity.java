        ...
        com.google.android.gms.location.LocationListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        SettingsButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(CustomersMapsActivity.this, SettingsActivity.class);
        ...
        CallCabCarButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                else
                {
                    ...
                    PickUpMarker = mMap.addMarker(new MarkerOptions().position(CustomerPickUpLocation).title("My Location").icon(BitmapDescriptorFactory.fromResource(R.drawable.users)));
